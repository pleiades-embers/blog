...
/**
 * Heightmap 是 Minecraft 中的一个类，它用于存储区块（chunk）中每个 X 和 Z 坐标的最高非空气方块的 Y 值。
 * 这可以用于快速找到地表高度，而不需要遍历整个区块的所有方块。
 */
public class Heightmap {
   ...
   /**
    * data：这是一个 BitStorage 对象，用于存储高度图的数据。BitStorage 是一个用于有效存储和操作比特数据的类。
    */
